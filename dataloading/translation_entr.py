...
VALID_EN = "/dev/sgm/newstest2017-entr-src.en.sgm"
VALID_TR = "/dev/sgm/newstest2017-entr-ref.tr.sgm"

TEST_EN = "/dev/sgm/newstest2018-entr-src.en.sgm"
TEST_TR = "/dev/sgm/newstest2018-entr-ref.tr.sgm"
...
class MT(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        train_file_l1 = "data/entr/SETIMES.en-tr.%s" % self.config.lang1
        train_file_l2 = "data/entr/SETIMES.en-tr.%s" % self.config.lang2

        dev_file = dl_manager.download_and_extract(_DEV_FOLDER)
        valid_file_l1 = VALID_EN if self.config.lang1 == "en" else VALID_TR
        valid_file_l2 = VALID_EN if self.config.lang2 == "en" else VALID_TR
        test_file_l1 = TEST_EN if self.config.lang1 == "en" else TEST_TR
        test_file_l2 = TEST_EN if self.config.lang2 == "en" else TEST_TR
